...
async def get_users(
    ...
    sort_by: str = Query("full_name", regex="^(id|full_name|university|contact|matches_played|wins_count|sum_points|registered|eliminated)$"),  # Добавляем eliminated в сортировку
